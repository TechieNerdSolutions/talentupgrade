<div class="col-lg-9  order-md-1 course_col" id = "video_player_area">
    ...
    <div class="" style="text-align: center;">
                ...
                <?php else: ?>
                    <div class="mt-5">
                        <a href="<?php echo base_url().'uploads/lesson_files/'.$lesson_details['attachment']; ?>" class="btn btn-sign-up" download style="color: #fff;">
                            <i class="fa fa-download" style="font-size: 20px;"></i> <?php echo translate('download').' '.$lesson_details['title']; ?>
                        </a>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
        ...
        <div class="" style="margin: 20px 0;" id = "lesson-summary">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?php echo $lesson_details['lesson_type'] == 'quiz' ? translate('instruction') : translate("note"); ?>:</h5>
                    <?php if ($lesson_details['summary'] == ""): ?>
                        <p class="card-text"><?php echo $lesson_details['lesson_type'] == 'quiz' ? translate('no_instruction_found') : translate("no_summary_found"); ?></p>
                    <?php else: ?>
