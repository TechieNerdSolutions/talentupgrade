...
<div class="alert alert-info" role="alert">
    ...
    <strong><a href="#" class="ml-1" data-toggle="modal" data-dismiss="modal" onclick="showAjaxModal('<?php echo site_url('modal/popup/lesson_types/'.$param2.'/'.$param3); ?>', '<?php echo translate('add_new_lesson'); ?>')" style="color:white"><?php echo translate("change"); ?></a></strong>
</div>
