                   ...
                   <div class="col-sm-12">
					...
					<div class="panel-body table-responsive">
                           ...
                           <a href="<?php echo base_url();?>user/new_course" 
                     			class="btn btn-default btn-xs pull-right"><i class="fa fa-mail-reply-all"></i>&nbsp;<?=translate('new_course')?>
                    		</a>
							<hr class="sep-2">
...
<section>
                                <div class="sttabs tabs-style-bar">
                                    <nav>
                                        <ul>
											<li><a href="#section-bar-0" class="sticon ti-angle-double-right"><span><?=translate('curriculum')?></span></a></li>
									...
									<form class="required-form" action="<?php echo site_url('user/courses/edit/'.$course_id); ?>" method="post" enctype="multipart/form-data">
                                    <div class="content-wrap">
                                            ...
                                            <h3>Fill neccessary information for this course : </h3>
												...
												<div class="form-group">
                                                    ...
                                                    <select class="form-control select2" data-toggle="select2" name="level" id="level">
                                                        ...
                                                        <option value="intermediate" <?php if($course_details['level'] == "intermediate") echo 'selected'; ?>><?php echo translate('intermediate'); ?>
                                                        </select>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<select class="form-control" id="language_made_in" name="language_made_in" /required>
															...
															?>
															<option value="<?php echo $field; ?>" <?php if ($course_details['language'] == $field) echo 'selected'; ?>>
												...
												<div class="form-group">
													<div class="col-sm-12">
														<input type="checkbox" class="js-switch" value="1" name="is_top_course" <?php if($course_details['is_top_course'] == 1) echo 'checked'; ?>> <i></i> 
                                        ...
                                        <section id="section-bar-3">
                                            <h2>Please enter the price student will see before purchasing the course.</h2>
												...
												<div class="form-group">
													<div class="col-sm-12">
														<input type="checkbox" id="is_free_course" value="1" name="is_free_course" <?php if($course_details['is_free_course'] == 1) echo 'checked'; ?>> <i></i> <?=translate('is_this_a_free_course')?>?
													</div>
												</div>
													...
													<div id="initial">
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																...
																placeholder="<?php echo translate('enter_course_course_price'); ?>" value="<?php echo $course_details['price']; ?>" min="0">
															</div>
														</div>
														
														<div class="form-group">
															<div class="col-sm-12">
																<input type="checkbox"  name="discount_flag" id="discount_flag" value="1" <?php if($course_details['discount_flag'] == 1) echo 'checked'; ?>>
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																...
																id="discounted_price" onkeyup="calculateDiscountPercentage(this.value)" min="0" value="<?php echo $course_details['discounted_price']; ?>">
                                                    ...
                                                    <option value="html5"><?php echo translate('HTML5'); ?></option>
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																...
																id="course_overview_url" placeholder="E.g: https://www.youtube.com/watch?v=CPfCjdPXs8I" value="<?php echo $course_details['video_url'] ?>" /required>
															</div>
														</div>
                                            ...
                                            <h2>SEO</h2>
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																...
																data-role="tagsinput" placeholder="<?php echo translate('write_a_keyword_and_then_press_enter'); ?>" style="width:100%;" value="<?php echo $course_details['meta_keywords']; ?>" />
															</div>
														</div>
