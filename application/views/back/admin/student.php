		...
		<div class="panel panel-default">
			<div class="panel-heading">&nbsp;
				<div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;
					<?=translate('add_new_student');?> </a> <a href="#" data-perform="panel-dismiss"></a> 
				</div>
			</div>
			...
			<form class="required-form" action="<?=site_url('admin/student/add'); ?>" enctype="multipart/form-data" method="post">
					<div class="row">
                    <div class="col-sm-6">
...
<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-info">              
			<div class="panel-body table-responsive"><?=translate('list_student');?>
				...
				<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <th><?=translate('enrolled_courses'); ?></th>
                  ...
                  <tbody>
                          ...
                          <tr>
                              <td><img src="<?=$this->user_model->get_user_image_url($user['id']);?>" alt="User Image" width="40" height="40" class="img-circle" ></td>
							  ...
							  <?php
							 	 $enrolled_courses = $this->crud_model->enrol_history_by_user_id($user['user_id']);
							  ?>
							  ...
							  <?php if($course_details['title'] == "") : ?>
								<span class="label label-danger">No enrol course(s) for now</span>
							  <?php endif;?>
							...
							<a href="javascript:;" onclick="showAjaxModal('<?=base_url()?>modal/popup/edit_student/<?=$user['id']?>');">
								<button type="button" class="btn btn-rounded btn-sm btn-success"><i class="fa fa-edit"></i>&nbsp;<?=translate('edit_student');?></button>
							</a>
							
						
                            <a href="#" onclick="confirm_modal('<?=base_url()?>admin/student/delete/<?=$user['id']?>');">
								<button type="button" class="btn btn-danger btn-rounded btn-sm"><i class="fa fa-times"></i> <?=translate('delete_student');?></button>
							</a>
