...
<section>
                                <div class="sttabs tabs-style-bar">
                                    <nav>
                                        <ul>
                                            <li><a href="#section-bar-0" class="sticon ti-angle-double-right"><span><?=translate('course_lesson')?></span></a></li>
									...
									<form class="required-form" action="<?php echo site_url('admin/courses/edit/'. $course_id); ?>" method="post" enctype="multipart/form-data">
                                    <div class="content-wrap">

                                        <section id="section-bar-0">
                                        <h3>Please add course lessons here : </h3>
                                        ...
                                        <section id="section-bar-1">
                                            <h3>Fill neccessary information for this course : </h3>
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<textarea name="short_description" id= "short_description" rows="3" class="form-control"><?php echo $course_details['short_description'];?></textarea>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-md-12" for="example-text"><?=translate('description');?> <b>*</b></label>
													<div class="col-sm-12">
														<textarea name="description" id= "mymce" class="form-control"><?php echo $course_details['description'];?></textarea>
													</div>
												</div>
														...
														<select class="form-control select2" data-toggle="select2" name="sub_category_id" id="sub_category_id" required>
                                                            ...
                                                            <?php foreach ($categories->result_array() as $category): ?>
                                                                <optgroup label="<?php echo $category['name']; ?>">
                                                                    ...
                                                                    <?php if($sub_category['id'] == $course_details['sub_category_id']) echo 'selected="selected"' ;?>><?php echo $sub_category['name']; ?></option>
                                                                <?php endforeach; ?>
                                                            </optgroup>
                                                        <?php endforeach; ?>
                                                    </select>
												...
												<div class="form-group">
                                                    ...
                                                    <select class="form-control select2" data-toggle="select2" name="level" id="level">
                                                        <option value="beginner"<?php if($course_details['level'] == 'beginner') echo 'selected';?>><?php echo translate('beginner'); ?></option>
                                                        <option value="intermediate"<?php if($course_details['level'] == 'intermediate') echo 'selected';?>><?php echo translate('intermediate'); ?></option>
                                                        <option value="advanced"<?php if($course_details['level'] == 'advanced') echo 'selected';?>><?php echo translate('advanced'); ?></option>
                                                    </select>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<select class="form-control" id="language_made_in" name="language_made_in" /required>
															...
															?>
															<option value="<?php echo $field; ?>"<?php if($course_details['language'] == $field) echo 'selected';?>><?php echo ucwords($field); ?></option>
															<?php }?>
														</select>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="col-sm-12">
														<input type="checkbox" class="js-switch" <?php if($course_details['is_top_course'] == 1) echo 'checked' ;?> value="1" name="is_top_course"> <i></i> 
                                        ...
                                        <section id="section-bar-2">
                                           ...
                                           <span id="designation">
													...
													<div class="row form-group">
														<div class="col-sm-11">
															<input type="text" class="form-control"  name="requirements[]" id="requirements" value="requirements here">
														</div>
												...
												<span id="designation_input">
														...
														<div class="row form-group">
															...
															<div class="col-sm-11">
																<input type="text" class="form-control"  name="requirements[]" id="requirements" placeholder="<?php echo $requirement; ?>">
															</div>
                                            ...
                                            <?php if (count(json_decode($course_details['outcomes'])) > 0): ?>
													...
													<div class="row form-group">
													  <label class="col-sm-12" for="example-text"><?=translate('course_objectives');?> <b>*</b></label>
														...
														<div class="col-sm-11">
															<input type="text" class="form-control" name="outcomes[]" id="outcomes" placeholder= "course expected outsomes here" value="<?php echo $outcome; ?>">
														</div>
                                        ...
                                        <section id="section-bar-3">
                                            <h2>Please enter the price student will see before purchasing the course.</h2>
												...
												<div class="form-group">
													<div class="col-sm-12">
														<input type="checkbox" <?php if($course_details['is_free_course'] == 1) echo 'checked';?> id="is_free_course" value="1" name="is_free_course"> <i></i> <?=translate('is_this_a_free_course')?>?
													</div>
												</div>
													...
													<div id="initial">
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																<input type="number" class="form-control" value="<?php echo $course_details['price'];?>" id="price" name = "price" 
														...
														<div class="form-group">
															<div class="col-sm-12">
																<input type="checkbox" <?php if($course_details['discount_flag'] == 1) echo 'checked';?>  name="discount_flag" id="discount_flag" value="1">
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																<input type="number" class="form-control" value="<?php echo $course_details['discounted_price'];?>" name="discounted_price" 
                                        ...
                                        <section id="section-bar-4">
                                            <h2>Ensure you put course preview and select type of preview for the course</h2>
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																<select class="form-control select2" data-toggle="select2" 
																	...
																	<option value="html5"<?php if($course_details['course_overview_provider'] == 'html5') echo 'selected';?>><?php echo translate('HTML5'); ?></option>
																	<option value="vimeo"<?php if($course_details['course_overview_provider'] == 'vimeo') echo 'selected';?>><?php echo translate('vimeo'); ?></option>
																	<option value="youtube"<?php if($course_details['course_overview_provider'] == 'youtube') echo 'selected';?>><?php echo translate('youtube'); ?></option>
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																<input type="text" class="form-control" name="course_overview_url"  value="<?php echo $course_details['video_url'];?>"
														...
														<div class="form-group">
															...
															<div class="col-sm-12">
																...
																<img id="blah"  src="<?php echo $this->crud_model->get_course_thumbnail_url($course_details['id'], 'course_thumbnail');?>" alt="your image" height="150" width="150"/ style="border:1px dotted red">
															</div>
														</div>
								...
								<hr class="sep-2">
							<button type="submit" class="btn btn-default btn-sm btn-rounded btn-block"> <i class="fa fa-plus"></i>&nbsp;<?php echo translate('update');?></button>
...
<script type="text/javascript">
    ...
    var blank_designation = '';
    $(document).ready(function () {
        blank_designationII = $('#designation_inputII').html();
    });
	
	
    function add_designationII(){
        $("#designationII").append(blank_designationII);
    }
