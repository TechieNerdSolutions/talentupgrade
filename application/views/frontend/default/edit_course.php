        ...
        <div class="basic-group">
            <form action="<?php echo site_url('home/course_action/edit/'.$course_id); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="title"><?php echo translate('basics'); ?>:</label>
                        <input type="text" class="form-control" name = "title" id="title" placeholder="<?php echo translate('title'); ?>" required value="<?php echo $course_details['title']; ?>">
                    </div>

                    <div class="form-group">
                        <label for="short_description"><?php echo translate('short_description'); ?>:</label>
                ...
                <div class="form-group">
                    <label class="form-label"><?php echo translate('sub_category'); ?></label>
                    <div class="controls">
                ...
                <div class="form-group">
                    <label for="description"><?php echo translate('level'); ?>:</label>
                ...
                <div class="form-group">
                    <label for="description"><?php echo translate('language_made_in'); ?>:</label>
                ...
                <div class="form-group">
                    <div class="checkbox check-success">
                        ...
                        <label for="isTopCourseCheckbox" onclick="topCourseChecked(this)"><?php echo translate('is_top_course'); ?></label>
                    </div>
                </div>
                ...
                <div id = "outcomes_area" style="padding: 0; margin : 0;">
                    ...
                    foreach (json_decode($course_details['outcomes']) as $outcome):?>
                        <?php if ($counter == 0):
                            $counter++; ?>
                            <div class="form-group">
                                <label class="form-label"><?php echo translate('outcomes'); ?></label>
                                <div class="controls">
                ...
                <div id = "requirement_area">
                    ...
                    foreach (json_decode($course_details['requirements']) as $requirement):?>
                        <?php if ($counter == 0):
                            $counter++; ?>
                            <div class="form-group">
                                <label class="form-label"><?php echo translate('requirements'); ?></label>
                                <div class="controls">
            ...
            <div class="basic-group">
                <div class="row-fluid">
                    <div class="checkbox check-success">
                        ...
                        <label for="freeCourseCheckbox" onclick="isFreeCourseChecked()"><?php echo translate('free_course'); ?></label>
                    </div>
                </div>

                <div class="form-group">
                    <label class="form-label"><?php echo translate('price').'<strong> ('.get_settings('system_currency').')</strong>'; ?></label>
                    <div class="controls">
                ...
                <div class="row-fluid">
                    <div class="checkbox check-success">
                        ...
                        <label for="discountCheckbox" onclick="priceChecked(this)"><?php echo translate('has_discount'); ?></label>
                    </div>
                </div>

                <div class="form-group">
                    <label class="form-label"><?php echo translate('discounted_price').'<strong> ('.get_settings('system_currency').')</strong>'; ?></label>
                    <div class="controls">
                ...
                <div class="content-box">
                    <div class="email-group">
                        <div class="form-group">
                            ...
                            <label class="form-label" style="color: red; font-weight: bold;"><?php echo translate('note').': '.translate('thumbnail_size_should_be_600_X_600');?></label>
                        </div>
                    </div>
                </div>

                <div class="form-group">
                    <label for="description"><?php echo translate('course_overview_provider'); ?>:</label>
                ...
                <div class="form-group">
                    <label class="form-label" for = "course_overview_url"><?php echo translate('course_overview_url'); ?></label>
                    <div class="controls">
                ...
                <div class="form-group">
                    <label class="form-label" for = "meta_keywords"><?php echo translate('meta_keywords'); ?></label>
                    <div class="controls">
                ...
                <div class="form-group">
                    <label for="meta_description"><?php echo translate('meta_description'); ?>:</label>
            ...
            <div class="content-update-box">
                <button type="submit" name = "publish" class="btn col-4"><?php echo translate('publish_this_course'); ?></button>
                <button type="submit" name = "save_to_draft" class="btn col-4" style="background-color: #2196F3; border-color: #2196F3;"><?php echo translate('save_to_draft'); ?></button>
            </div>
        </form>
    </div>
</div>
