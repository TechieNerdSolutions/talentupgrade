    ...
    <div class="content-box" id = "add_form_area">
        <form action="<?php echo site_url('home/sections/add/'.$course_id); ?>" id = "ajaxFormForAdding" onsubmit="addSection(event)" method="post" enctype="multipart/form-data">
            ...
            <div class="content-update-box">
                <button type="submit" name = "submit" class="btn col-4"><?php echo translate('add_section'); ?></button>
            </div>
        </form>
    </div>
    <div class="content-box" id = "edit_form_area" style="display: none;">
        <form action="" id = "ajaxFormForUpdating" onsubmit="updateSection(event)" method="post" enctype="multipart/form-data">
            <div class="basic-group">
                <div class="form-group">
                    <label for="title"><?php echo translate('title'); ?>:</label>
                    <input type="text" class="form-control" name = "title" id="section_title_for_editing" placeholder="<?php echo translate('title'); ?>" required>
                </div>
            </div>
            <div class="content-update-box">
                <button type="submit" name = "submit" class="btn col-4"><?php echo translate('update_section'); ?></button>
                <button type="button" name = "reset" class="btn col-4" onclick="resetForm()"><?php echo translate('reset'); ?></button>
            </div>
        </form>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo translate('lessons'); ?></th>
            ...
            <tbody>
                <?php
                    ...
                    <?php foreach ($sections as $section):
                        ...
                        <td>
                            <a href="#" onclick="addNameAndIdOnForm('<?php echo $section ?>', '<?php echo $section_details['title'] ?>')"><?php echo translate('edit'); ?></a>
                            <a href="#" onclick="confirm_modal('<?php echo site_url('home/sections/delete/'.$course_id.'/'.$section); ?>');"><?php echo translate('delete'); ?></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
