<?php
    $category_name        = translate('all_category');
    $sub_category_name    = translate('all_sub_category');
?>
        ...
        <div class="row">
            <div class="col">
                <div class="category-filter-box filter-box clearfix">
                    <a href = "<?php echo site_url('home/all_category'); ?>" class="btn btn-outline-secondary all-btn"><?php echo translate('all'); ?></a>
                </div>
                            ...
                            <div class="course-box-2">
                                    ...
                                    <div class="course-meta">
                                        <span class=""><i class="fas fa-play-circle"></i>
                                            <?php
                                                ...
                                                echo $number_of_lessons.' '.translate('lessons');
                                             ?>
                                        </span>
                                ...
                                <div class="course-price-rating">
                                    ...
                                    <div class="rating-number">
                                        <?php echo $this->crud_model->get_ratings('course', $course['id'])->num_rows().' '.translate('ratings'); ?>
                                    </div>
                                </div>
                            </div>
                        </li>
