<section class="page-header-area my-course-area">
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="page-title"><?php echo translate('my_wishlist'); ?></h1>
                <ul>
                  <li><a href="<?php echo site_url('home/my_courses'); ?>"><?php echo translate('all_courses'); ?></a></li>
                  <li class="active"><a href="<?php echo site_url('home/my_wishlist'); ?>"><?php echo translate('wishlists'); ?></a></li>
                ...
                <div class="my-course-search-bar">
                    <form action="">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="<?php echo translate('search_my_courses'); ?>" onkeyup="getMyWishListsBySearchString(this.value)">
                                ...
                                <div class="instructor-img-hover">
                                    ...
                                    <span>
                                        <?php
                                            ...
                                            echo $lessons.' '.translate('lessons');
                                        ?>
                                    </span>
                                    <span>
                                        <?php
