<div class="col-lg-9">
    ...
    <div class="in-cart-box">
        <div class="title"><?php echo sizeof($this->session->userdata('cart_items')).' '.translate('courses_in_cart'); ?></div>
        <div class="">
                    ...
                    <li>
                        <div class="cart-course-wrapper">
                            ...
                            <div class="move-remove">
                                <div id = "<?php echo $course_details['id']; ?>" onclick="removeFromCartList(this)"><?php echo translate('remove'); ?></div>
...
<div class="col-lg-3">
    <div class="cart-sidebar">
        <div class="total"><?php echo translate('total'); ?>:</div>
        ...
        <button type="button" class="btn btn-primary btn-block checkout-btn" onclick="handleCheckOut()"><?php echo translate('checkout'); ?></button>
    </div>
</div>
    ...
    $.ajax({
        ...
        success: function(response)
        {
            if (!response) {
                ...
                toastr.error('<?php echo translate('there_are_no_courses_on_your_cart');?>');
            }
        }
    });
}
