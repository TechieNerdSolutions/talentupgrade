...
<div class="form-group">
    <label> <?php echo translate('upload_system_video_file'); ?>( <?php echo translate('for_web_and_mobile_application'); ?> )</label>
    <div class="input-group">
        <div class="custom-file">
            ...
            <label class="custom-file-label" for="system_video_file"><?php echo translate('select_system_video_file'); ?></label>
        </div>
    </div>
    ...
    <small class="badge badge-secondary"><?php echo '"post_max_size" '.translate("has_to_be_bigger_than").' "upload_max_filesize"'; ?></small>
</div>
<div class="form-group">
    <label><?php echo translate('duration'); ?>( <?php echo translate('for_web_and_mobile_application'); ?> )</label>
