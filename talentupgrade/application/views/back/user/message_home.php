			...
			<div class="chat-left-inner">
				...
				<ul class="chatonline style-none ">
                    ...
                    foreach($message_threads as $row):
                        ...
                        ?>
					<li>
						<a class="<?php if (isset($current_message_thread_code) && $current_message_thread_code == $row['message_thread_code'])echo 'active';?>" href="<?php echo site_url('user/message/message_read/' . $row['message_thread_code']);?>">
						<img src="<?php echo $this->user_model->get_user_image_url($user_to_show_id);?>" class="img-circle" draggable="false"/> <span>
                                ...
                                <h3 class="box-title">Chat Message
									 <div class="btn-group pull-right">
										...
										<ul class="dropdown-menu">
											<li><a href="<?php echo base_url(); ?>user/message/message_new">New Message</a> </li>
										</ul>
									 </div>
								</h3>
                            </div>
