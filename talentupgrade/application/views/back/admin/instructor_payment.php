			...
			<div class="panel-body table-responsive"> 
											...
											<tbody>
                                                ...
                                                ?>
													<tr class="gradeU">
														...
														<!--<td> <a href="" class="btn btn-outline-primary btn-rounded btn-sm"><i class="mdi mdi-printer-settings"></i></a> </td>-->
													</tr>
                                                    <?php } ?>
                                ...
                                ?>
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td> <?php echo currency($pending_payout_user_data['amount']);?> </td>
											<td><?php echo date('D, d M Y', $pending_payout_user_data['date_added']);?></td>
                                            <td style="text-align: center;">
                                             ...
                                             <?php if($paypal_keys[0]['production_client_id'] != "") : ?>
                                                ...
                                                <!-- <a href="" class="btn btn-outline-primary btn-rounded btn-sm"><i class="mdi mdi-printer-settings"></i></a>-->
