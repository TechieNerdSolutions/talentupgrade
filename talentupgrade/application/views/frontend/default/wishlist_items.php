...
<div class="dropdown course-list-dropdown corner-triangle top-right">
    <div class="list-wrapper">
                            ...
                            <div class="item-details">
                                <a href="">
                                    ...
                                    <div class="instructor-name">
                                        <?php echo translate('by').' '.$instructor_details['first_name'].' '.$instructor_details['last_name']; ?>
                                    </div>
        ...
        <div class="dropdown-footer">
            <a href = "<?php echo site_url('home/my_wishlist'); ?>"><?php echo translate('go_to_wishlist'); ?></a>
        </div>
    </div>
    <div class="empty-box text-center d-none">
        <p><?php echo translate('your_wishlist_is_empty'); ?>.</p>
        <a href=""><?php echo translate('explore_courses'); ?></a>
    </div>
</div>
