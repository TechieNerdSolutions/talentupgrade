            ...
            <div class="col-lg-8" style="padding: 35px;">
                <div class="content-box">
                    <div class="basic-group">
                        <form action="<?php echo site_url('home/course_action/create'); ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name = "title" id="title" placeholder="<?php echo translate('title'); ?>" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select class="form-control" id="sub_category_id" name="sub_category_id" required>
                                    <option value=""><?php echo translate('select_a_category_first'); ?></option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="content-update-box">
                        <button type="submit" name = "create_course" class="btn col-4"><?php echo translate('create_course'); ?></button>
