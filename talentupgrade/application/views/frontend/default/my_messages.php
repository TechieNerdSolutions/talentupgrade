...
<section class="page-header-area my-course-area">
    <div class="container">
        <div class="row">
            <div class="col">
                <h1 class="page-title"><?php echo translate('my_messages'); ?></h1>
                <ul>
                  ...
                  <li class="active"><a href="<?php echo site_url('home/my_messages'); ?>"><?php echo translate('my_messages'); ?></a></li>
                    ...
                    <ul class="message-sender-list">
                        ...
                        foreach ($message_threads as $row):
                            ...
                            <a href="<?php echo site_url('home/my_messages/read_message/'.$row['message_thread_code']); ?>">
                                <li>
                                    <div class="message-sender-wrap view">
                ...
                <div class="message-details-box" id = "toggle-2" style="display: none;">
                    <div class="new-message-details"><div class="message-header">
                        <div class="sender-info">
                            ...
                            <span class="d-inline-block"><?php echo translate('new_message'); ?></span>
                        </div>
                    </div>
                    <form class="" action="<?php echo site_url('home/my_messages/send_new'); ?>" method="post">
                        <div class="message-body">
                            ...
                            <button type="submit" class="btn send-btn"><?php echo translate('send'); ?></button>
