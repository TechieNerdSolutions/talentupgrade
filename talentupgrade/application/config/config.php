...
|
*/
$config['encryption_key'] = 'RachamvSoftlab';
...
$config['sess_save_path'] = FCPATH . 'sessions/ulop/';
...
$config['csrf_token_name'] = 'rachamvsoftlab';
$config['csrf_cookie_name'] = 'rachamnsoftlab ';
